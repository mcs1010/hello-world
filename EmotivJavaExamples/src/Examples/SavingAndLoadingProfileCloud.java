...
public class SavingAndLoadingProfileCloud {
	...
	public static void main(String[] args) {
		...
		IntByReference engineUserID = new IntByReference(0);
		IntByReference userCloudID = new IntByReference(0);
		IntByReference profileID = new IntByReference(-1);
		...
		while (true) {
			...
			if (ready) {
				...
				System.out.println(getNumberProfile);
				switch (option) {
					case 1:{    
