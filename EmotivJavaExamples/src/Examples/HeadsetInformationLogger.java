...
public class HeadsetInformationLogger {
	public static void main(String[] args) {
		...
		int state = 0;
		boolean onStateChanged = true;
		boolean readytocollect = true;
		...
		while (true) {
			...
			if (state == EdkErrorCode.EDK_OK.ToInt()) {
				...
				if (readytocollect && onStateChanged)
				{
					...
					System.out.print(EmoState.INSTANCE.IS_GetContactQuality(eState, IEE_InputChannels_t.IEE_CHAN_AF3.getType()) + ", ");
