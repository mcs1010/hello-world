...
public interface EmoState extends Library  
{
	EmoState INSTANCE = (EmoState)Native.loadLibrary("edk",EmoState.class);
    	...
    	public enum EE_CognitivAction_t {
    		...
    		COG_LEFT						 (0x0020),//32
    		COG_RIGHT						 (0x0040),//64
    		COG_ROTATE_LEFT					 (0x0080),//128
    		COG_ROTATE_RIGHT				 (0x0100),//256
    		COG_ROTATE_CLOCKWISE			 (0x0200),//512
    		COG_ROTATE_COUNTER_CLOCKWISE	 (0x0400),//1028
    		COG_ROTATE_FORWARDS				 (0x0800),//2048
    		COG_ROTATE_REVERSE				 (0x1000),//4096
    		COG_DISAPPEAR					 (0x2000);//8192
