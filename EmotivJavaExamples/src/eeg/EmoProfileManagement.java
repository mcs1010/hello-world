...
public class EmoProfileManagement {
    ...
    public static void LoadProfilesFromFile() {
    	...
    	System.out.println("Number of Current Profiles: "+userProfiles.size());
    	for(int k = 0;k<userProfiles.size();k++)
    	{
    		System.out.println("Name on profile: "+userProfiles.get(k).profileName);
    	}
    }
    ...
    /// <returns></returns>
    public static int  FindProfileName(String prName) {
        int i = 0;
