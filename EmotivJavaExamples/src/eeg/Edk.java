...
public interface Edk extends Library {
    ...
    //DEPLOYMENT::STABLE_RELEASE::REMOVE_START
    	...
    	public enum EE_Event_t {
    		EE_UnknownEvent		 (0x0000),//0
    		EE_EmulatorError	 (0x0001),//1
    		EE_ReservedEvent	 (0x0002),//2
    		EE_UserAdded		 (0x0010),//16
    		EE_UserRemoved		 (0x0020),//32
    		EE_EmoStateUpdated	 (0x0040),//64
    		EE_ProfileEvent		 (0x0080),//128
    		EE_CognitivEvent	 (0x0100),//256
    		EE_ExpressivEvent	 (0x0200),//512
    		EE_InternalStateChanged  (0x0400),//1024
    		EE_AllEvent			 (0x07F0);
